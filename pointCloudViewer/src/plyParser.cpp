...
PlyElement* find_element(PlyFile_t*, char*);
...
void add_element(PlyFile_t*, char**, int);
void add_property(PlyFile_t*, char**, int);
void add_comment(PlyFile_t*, char*);
void add_obj_info(PlyFile_t*, char*);
...
void ascii_get_element(PlyFile_t*, char*);
void binary_get_element(PlyFile_t*, char*);
...
Exit:
  returns a pointer to a PlyFile_t, used to refer to this file, or NULL if error
******************************************************************************/
...
)
{
    ...
    plyfile = (PlyFile_t*)myalloc(sizeof(PlyFile));
...
PlyFile_t* ply_open_for_writing(
    char* filename,
    int nelems,
    char** elem_names,
    int file_type,
...
)
{
    ...
    /* create the actual PlyFile_t structure */
...
void ply_header_complete(PlyFile_t* plyfile)
{
    int i, j;
    FILE* fp = plyfile->fp;
    PlyElement* elem;
...
void ply_put_element_setup(PlyFile_t* plyfile, char* elem_name)
{
    PlyElement* elem;
...
void ply_put_element(PlyFile_t* plyfile, void* elem_ptr)
{
    int i, j, k;
    FILE* fp = plyfile->fp;
    PlyElement* elem;
...
void ply_put_comment(PlyFile_t* plyfile, char* comment)
{
...
void ply_put_obj_info(PlyFile_t* plyfile, char* obj_info)
{
...
PlyFile_t* ply_read(FILE* fp, int* nelems, char*** elem_names)
{
    int i, j;
    PlyFile_t* plyfile;
    int nwords;
...
PlyFile_t* ply_open_for_reading(
    char* filename,
    int* nelems,
    char*** elem_names,
    int* file_type,
...
)
{
    ...
    /* create the PlyFile_t data structure */
...
void ply_get_element(PlyFile_t* plyfile, void* elem_ptr)
{
    if (plyfile->file_type == PLY_ASCII)
...
char** ply_get_comments(PlyFile_t* plyfile, int* num_comments)
{
...
char** ply_get_obj_info(PlyFile_t* plyfile, int* num_obj_info)
{
...
void setup_other_props(PlyFile_t* plyfile, PlyElement* elem)
{
    int i;
    PlyProperty* prop;
    int size = 0;
...
void ply_put_other_elements(PlyFile_t* plyfile)
{
    int i, j;
    OtherElem* other;
...
void ply_close(PlyFile_t* plyfile)
{
    fclose(plyfile->fp);
...
/******************************************************************************
Get version number and file type of a PlyFile_t.
...
void ply_get_info(PlyFile_t* ply, float* version, int* file_type)
{
    if (ply == NULL)
        return;
...
PlyElement* find_element(PlyFile_t* plyfile, char* element)
{
    int i;
...
void ascii_get_element(PlyFile_t* plyfile, char* elem_ptr)
{
    int i, j, k;
    PlyElement* elem;
    PlyProperty* prop;
...
void binary_get_element(PlyFile_t* plyfile, char* elem_ptr)
{
    int i, j, k;
    PlyElement* elem;
    PlyProperty* prop;
...
void add_element(PlyFile_t* plyfile, char** words, int nwords)
{
    PlyElement* elem;
...
void add_property(PlyFile_t* plyfile, char** words, int nwords)
{
    int prop_type;
    int count_type;
    PlyProperty* prop;
...
void add_comment(PlyFile_t* plyfile, char* line)
{
    int i;
...
void add_obj_info(PlyFile_t* plyfile, char* line)
{
    int i;
